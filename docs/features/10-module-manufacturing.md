# FE-10 — Module Manufacturing

**Route:** `/module-manufacturing/` · **Parent nav group:** Businesses
...
1. `<PageHero>` — title "Module Manufacturing", hero image, breadcrumb Home › Businesses › Module Manufacturing
2. `<ProseBlock>` — overview copy. `{{TODO: content — port from https://www.sael.co/module-manufacturing/}}`
...
Business icon: `icons/business-module-manufacturing.svg` (from FE-02). Hero and facility photography: `{{TODO: assets — client to supply}}`. Do not reuse homepage hero crops as page heroes; the aspect ratios differ.
