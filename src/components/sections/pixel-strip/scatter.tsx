...
/**
 * How quickly the squares thin out going up. Above 1 the fall-off is
 * front-loaded, so the rows nearest the bar stay dense and the top few are
 * almost empty — a dissolve rather than a linear fade.
 */
const FALLOFF = 1.75;

/**
 * Solid rows added *beneath* the dissolve, not taken out of it.
 *
